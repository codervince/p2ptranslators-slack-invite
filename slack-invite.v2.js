...
function slack_invite() {
    ...
    <head>
        ...
        <style>
            ...
            body {
                font-family: "Ubuntu",Avenir,"Helvetica Neue",Hevetica,sans-serif;
            }
    ...
    <body style="padding-top: 30px;">
        <div class="container">
            <div class="jumbotron col-md-6 col-md-offset-3 text-center">
                ...
                <p><small>Check for an email from feedback@slack.com</small></p>
            </div>
            <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center">
                    <p>Powered by <a href="https://webtask.io">Auth0 Webtasks</a>
                    </p>
                </div>
            </div>
        </div>
